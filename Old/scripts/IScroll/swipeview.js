...
var SwipeView = (function (window, document) {
	var dummyStyle = document.createElement('div').style,
		...
		SwipeView = function (el, options) {
		    ...
		    if (this.wrapper.querySelector('#swipeview-slider')) {
		        div = this.wrapper.querySelector('#swipeview-slider');
		    } else {
			...
			for (i=-1; i<2; i++) {
		        if (this.slider.querySelector('#swipeview-masterpage-' + (i + 1))) {
		            div = this.slider.querySelector('#swipeview-masterpage-' + (i + 1));
		        } else {
				div = document.createElement('div');
